  ...
  render() {
    return(
      <View>
        ...
        <View style={{position: 'absolute', top: 0, left: 0, width:Dimensions.get('window').width, height:Dimensions.get('window').height, backgroundColor: 'blue'}}/>
        }
...
function mapStateToProps(state) {
  return {
    ...
    loadingUser: state.isLoadingUser
  }
}
